  ...
  const list = (anchor) => (
    ...
    >
      ...
      {authUser && (
        <MenuItem>
          <SignOutBtn />
          <Typography color="primary" variant="p" component="p" className={classes.logout}>
            Logout
          </Typography>
        </MenuItem>
      )}
      ...
      <div style={{ marginLeft: "16px", marginTop: "16px" }}>
        <Link href="https://instagram.com/nzy1337">
          <img style={{ width: "20px", marginRight: ".5rem" }} src={instagram} alt={"my description menu drawer"} />
        </Link>

        <Link href="https://facebook.com/nzy1337">
          <img style={{ width: "20px" }} src={facebook} alt={"facebook share"} />
        </Link>
      </div>
    </div>
  );
